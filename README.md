...
In this tutoral, we will be learning about Depth-First Search.  Depth-first search is an algorithm for searching tree or graph data structures.   If you would like to learn about another searching algorithm, Breadth-first Search, please click on <a href="https://zsheill7.github.io/BreadthFirstSearch/">this link</a>
